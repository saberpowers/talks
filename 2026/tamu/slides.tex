...
\begin{document}
  ...
  \begin{frame}
      \maketitle
      \vfill\hfill\includegraphics[width = 4cm]{../../assets/rice_logo_white.png}
  \end{frame}
  ...
  \begin{frame}{Background}
    ...
    \end{center}
    \hfill After \alert{\bf 3 failed pickoffs}, the runner advances automatically
  \end{frame}
  ...
  \begin{frame}{Background}
    ...
    \begin{itemize}
      \item Full pitch tracking data have been available for 20 years
