...
\begin{frame}{My Background}
  \begin{tikzpicture}
    \node (stanford) at (0, 0) {\includegraphics[width=1cm]{images/stanford.png}};
    \node at (0.5, -0.5) {\includegraphics[width=0.4cm]{images/school.png}};
    \node at (0, -0.8) {\tiny PhD Statistics};
    \pause
    \node (athletics) at (0.75, 2) {\includegraphics[width=1cm]{images/athletics.png}};
    \node at (1.25, 1.5) {\includegraphics[width=0.2cm]{images/baseball.png}};
    \draw[->] (stanford) -- (athletics);
    \pause
    \node (alkmaar) at (2.5, 2) {\includegraphics[width=1cm]{images/alkmaar.png}};
    \node at (3, 1.5) {\includegraphics[width=0.4cm]{images/soccer.png}};
    \draw[->] (athletics) -- (alkmaar);
    \node (pitt) at (1.5, 3.5) {\includegraphics[width=1cm]{images/pitt.jpg}};
    \draw[->, dashed, gray] (pitt) -- (athletics);
    \draw[->, dashed, gray] (pitt) -- (alkmaar);
    \pause
    \node (dodgers) at (3.25, 0) {\includegraphics[width=1cm]{images/dodgers.png}};
    \node at (3.75, -0.5) {\includegraphics[width=0.2cm]{images/baseball.png}};
    \node at (3.75, 0.5) {\includegraphics[width=0.5cm]{images/world_series.png}};
    \draw[->] (stanford) -- (dodgers);
    \pause
    \node (zelus) at (5, 2) {\includegraphics[width=0.8cm]{images/zelus.png}};
    \node at (5.5, 1.5) {\includegraphics[width=0.4cm]{images/soccer.png}};
    \draw[->] (alkmaar) -- (zelus);
    \node (redbird) at (6.75, 3.5) {\includegraphics[width=1cm]{images/redbird.png}};
    \node (toulouse) at (9, 3) {\includegraphics[width=1cm]{images/toulouse.png}};
    \node (milan) at (9, 4) {\includegraphics[width=1cm]{images/milan.png}};
    \draw[->, dashed, gray] (pitt) -- (redbird);
    \draw[->, dashed, gray] (redbird) -- (zelus);
    \draw[->, dashed, gray] (redbird) -- (toulouse);
    \draw[->, dashed, gray] (redbird) -- (milan);
    \pause
    \node (astros) at (7, 0) {\includegraphics[width=1cm]{images/astros.png}};
    \node at (7.5, -0.5) {\includegraphics[width=0.2cm]{images/baseball.png}};
    \node at (7.5, 0.5) {\includegraphics[width=0.5cm]{images/world_series.png}};
    \draw[->] (dodgers) -- (astros);
    \pause
    \node (rice) at (9, 0) {\includegraphics[width=1cm]{images/rice.png}};
    \node at (9.5, -0.5) {\includegraphics[width=0.4cm]{images/school.png}};
    \draw[->] (astros) -- (rice);
  \end{tikzpicture}
\end{frame}
...
\begin{frame}{Big Picture}
  \begin{tikzpicture}
    ...
    \node[align = center] (match performance) at (2.5, -2) {Match \\ Performance};
    \draw[->] (player evaluation) -- (training measurements);
    \draw[->] (player evaluation) -- (match performance);
    \pause
    \node at (-2.5, -3) {?};
    \pause
    \node (descriptive) at (0, -4) {Descriptive};
    \node (predictive) at (5, -4) {Predictive};
    \draw[->] (match performance) -- (descriptive);
    \draw[->] (match performance) -- (predictive);
    \pause
...
\begin{frame}{Big Picture}
  \begin{tikzpicture}
    \node[align = center] (player evaluation) at (0, 0) {Player \\ Evaluation};
    \node[align = center] (training measurements) at (-2.5, -2) {Training \\ Measurements};
    \node[align = center] (match performance) at (2.5, -2) {\bf Match \\ \bf Performance};
    \draw[->] (player evaluation) -- (training measurements);
    \draw[->] (player evaluation) -- (match performance);
    \node (descriptive) at (0, -4) {\bf Descriptive};
    \node (predictive) at (5, -4) {\bf Predictive};
    \draw[->, thick] (match performance) -- (descriptive);
    \draw[->, thick] (match performance) -- (predictive);
    \node (event-based) at (-2, -5.5) {Event-Based};
    \node (plus-minus) at (0, -6.25) {Plus-Minus};
    \draw[->] (descriptive) -- (event-based);
    \draw[->] (descriptive) -- (plus-minus);
...
\begin{frame}{Predictive Strategy \#1: Measure process, not results}
  ...
  \end{center}
  {\bf Football Example:} xG vs. goals
\end{frame}
...
\begin{frame}{Outline}
  \begin{enumerate}
    \item {\color{gray} My Background}
    \item {\color{gray} Player evaluation based on match performance}
    \begin{itemize}
      \color{gray}
      \item Descriptive metrics
      \item Predictive metrics
